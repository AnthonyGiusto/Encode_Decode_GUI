...
class EncodeGui:
    ...
    def __init__(self, master):
        ...
        self.index_number1 = (
            tk.Label(master, text="Enter Index",
        ...
        self.lbl_code = tk.Label(
            master, text="Encoded:", fg="white", bg="darkblue", font=font)
        ...
        self.btn_encode = tk.Button(
            text="Encode", command=self.encode_click,
            fg="white", bg="black", font=font)
        self.btn_encode.grid(column=3, row=2)

        # creates a label for the Number entry
        self.lbl_code = tk.Label(
            master, text="Code", fg="white", bg="darkblue", font=font)
        self.lbl_code.grid(column=1, row=6)

        # creates a label for the code result
        self.lbl_number2 = tk.Label(
            master, text="Decoded:", fg="white", bg="darkblue", font=font)
        ...
        self.btn_decode = tk.Button(
            text="Decode", command=self.decode_click, fg="white",
            bg="black", font=font)
    ...
    def encode_click(self):
        """Takes a user input value and encodes it with a
        predefined month index into a code-string"""
    ...
    def decode_click(self):
        """Takes a user input code-string and decodes it with
        a predefined month index into a number"""
